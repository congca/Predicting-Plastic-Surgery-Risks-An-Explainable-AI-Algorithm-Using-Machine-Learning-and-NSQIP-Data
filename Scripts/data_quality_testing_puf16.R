...
file.create( "postOutcomes16.tex")
...
for (i in colnames(pred_puf16)){
  ...
  if (nrow(temp) < 15) {
    ...
    write(temp_table,  "postPredictors16.tex", append = TRUE)
  }
}
...
for (i in colnames(outcomes_puf16)){
  ...
  if (nrow(temp) < 15) {
    ...
    # Append latex code to file
    write(temp_table, file = "postOutcomes16.tex", append = TRUE)
  }
}
...
for (i in colnames(pre16)){
  ...
  if (nrow(temp) < 15) {
    ...
    # Append latex code to file
    write(temp_table, file = "pre16.tex", append = TRUE)
  }
}
...
#### Export R Objects ####
save(pred_sum_testing_puf16, file = "pred_sum_testing_puf16.Rda")
save(outcome_sum_testing_puf16, file = "outcome_sum_testing_puf16.Rda")
