...
# data_processing_puf18.R must be run before running the script to generate the outcomes_puf18 object.
...
# Export R Object
save(grouped_outcomes_puf18, file =  "grouped_outcomes_puf18.Rda")
